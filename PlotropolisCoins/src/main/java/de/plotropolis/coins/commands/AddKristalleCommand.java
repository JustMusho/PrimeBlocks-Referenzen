...
public final class AddKristalleCommand implements CommandExecutor, TabCompleter {

    private final PlotropolisCoins plugin;

    public AddKristalleCommand(PlotropolisCoins plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (!sender.hasPermission("plotropoliscoins.admin.addkristalle")) {
        ...
        plugin.getDataStore().addKristalle(t.getUniqueId(), name, amount);

        send(sender, "admin-added-kristalle",
                "{player}", name,
