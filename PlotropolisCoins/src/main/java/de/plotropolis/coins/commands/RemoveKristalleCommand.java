...
public final class RemoveKristalleCommand implements CommandExecutor, TabCompleter {

    private final PlotropolisCoins plugin;

    public RemoveKristalleCommand(PlotropolisCoins plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (!sender.hasPermission("plotropoliscoins.admin.removekristalle")) {
        ...
        plugin.getDataStore().removeKristalle(t.getUniqueId(), name, amount);

        send(sender, "admin-removed-kristalle",
                "{player}", name,
