...
public final class SetMoneyCommand implements CommandExecutor, TabCompleter {

    private final PlotropolisCoins plugin;

    public SetMoneyCommand(PlotropolisCoins plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (!sender.hasPermission("plotropoliscoins.admin.setmoney")) {
        ...
        plugin.getDataStore().setMoney(t.getUniqueId(), name, amount);

        send(sender, "admin-set-money",
                "{player}", name,
